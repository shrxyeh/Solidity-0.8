...
contract Array {
    uint256[] public Arr = [1, 2, 3, 4]; //dynamic
    uint256[3] public fixedArr; //fixed

    function example() external {
        Arr.push(4); //[1,2,3,4,4]
        Arr[3] = 200; //[1,2,3,200,4]
        delete Arr[1]; //[1,0,3,200,4]//After deleting the length of the array remains the same
        Arr.pop(); //[1,0,3,200]removes last element of array as well as the lenght of array is reduced
